...
namespace program2
{
    public class OrderService
    {
        ...
        public OrderService()
        {
            ...
            Order order1 = new Order("20181111001", "王老板","13299097011");
            order1.SetOrder("雪碧", 10, 3.5);
            order1.SetOrder("可乐", 15, 4.0);
            order1.SetOrder("鲜橙多", 12, 7.0);
            order1.DCount = 3;
            Order order2 = new Order("20181101002", "李先生","13970778848");
        ...
        public bool AddOrder(string onum, string oname,string tel,
            string[] proName,int[] count,double[] price)
        {
            Order order = new Order(onum, oname,tel);
            olist.Add(order);
        ...
        public void ReviseOrder(string num,string[] proName, int[] count, double[] price)
        {
            ...
            for (int m = 0; m < olist.Count; m++)
            {
                try
                {
                    if (olist[m].ONum == num)
                    {
                        ...
                        tel = olist[m].Tel;
                        RemoveOrder(num);
                        AddOrder(num, oname,tel,proName,count,price);
                    }
